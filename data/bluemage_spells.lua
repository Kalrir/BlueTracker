...
M.LIST = {
    ...
    { 8,  'Cocoon',            'Mag',  'Earth',    'Buff',     'None',                'Defense +50%',         'Vermin',    10  },
    ...
    { 18, 'Blastbomb',         'Mag',  'Fire',     'Damage',   'None',                'Fire dmg (Bind)',      'Beastmen',  36  },
    ...
    { 28, 'Bomb Toss',         'Mag',  'Fire',     'Damage',   'Magic Accuracy',      'Fire dmg',             'Beastmen',  42,  true },
    ...
    { 32, 'Empty Thrash',      'Phys', 'Slashing', 'Damage',   'Max HP Boost',        'Unconfirmed',          '—',         nil, true },
    ...
    { 40, 'Terror Touch',      'Phys', 'H2H',      'Damage',   'Defense Bonus',       'Compression/Reverb.',  'Undead',    62  },
    ...
    { 44, 'Blitzstrahl',       'Mag',  'Thunder',  'Damage',   'None',                'Thunder dmg (Stun)',   'Arcana',    70  },
    ...
    { 46, 'Geist Wall',        'Mag',  'Dark',     'Dispel',   'None',                'AoE Dispel',           'Lizards',   35  },
    { 46, 'Magnetite Cloud',   'Mag',  'Earth',    'Damage',   'Magic Defense Bonus', 'Breath (Earth/Weight)','Beastmen',  86  },
    { 48, 'Blood Saber',       'Mag',  'Dark',     'Drain',    'None',                'AoE HP drain',         'Undead',    25  },
    { 48, 'Jettatura',         'Mag',  'Dark',     'Enfeeble', 'None',                'Terror',               'Birds',     37  },
    { 48, 'Refueling',         'Mag',  'Wind',     'Buff',     'None',                'Haste +10%',           'Arcana',    29  },
    ...
    { 50, 'Ice Break',         'Mag',  'Ice',      'Damage',   'Magic Defense Bonus', 'Ice dmg (Bind)',       'Arcana',    142 },
    ...
    { 54, 'Winds of Promyvion','Mag',  'Light',    'Enfeeble', 'Auto Refresh',        'None',                 '—',         nil, true },
    { 56, 'Feather Barrier',   'Mag',  'Wind',     'Buff',     'Resist Gravity',      'Evasion +20',          'Birds',     29  },
    { 58, 'Flying Hip Press',  'Mag',  'Wind',     'Damage',   'Max HP Boost',        'Breath (Wind)',        'Beastmen',  125 },
    { 58, 'Light of Penance',  'Mag',  'Light',    'Enfeeble', 'Auto Refresh',        'TP down / Blind',      'Beastmen',  53  },
    ...
    { 61, 'Maelstrom',         'Mag',  'Water',    'Damage',   'Clear Mind',          'Water dmg (STR down)', 'Aquans',    162 },
    ...
    { 65, 'Infrasonics',       'Mag',  'Ice',      'Enfeeble', 'None',                'Evasion down',         'Lizards',   42  },
    { 65, 'Zephyr Mantle',     'Mag',  'Wind',     'Buff',     'Conserve MP',         'Blink (4 shadows)',    'Dragons',   31  },
    { 66, 'Frost Breath',      'Mag',  'Ice',      'Damage',   'Conserve MP',         'Breath (Ice/Para.)',   'Lizards',   136 },
    ...
    { 74, 'Magic Hammer',      'Mag',  'Light',    'Damage',   'Magic Attack Bonus',  'Light dmg (MP drain)', 'Beastmen',  nil },
    { 74, 'Reactor Cool',      'Mag',  'Ice',      'Enfeeble', 'Magic Attack Bonus',  'None',                 '—',         nil },
